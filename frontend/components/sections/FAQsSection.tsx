      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12 p-8 bg-white rounded-lg shadow-md">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="inline-flex items-center px-6 py-3 border-2 border-primary text-primary font-medium rounded-lg hover:bg-primary hover:text-white transition-colors">
              Schedule a Call
              <svg className="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
