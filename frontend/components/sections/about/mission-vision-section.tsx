    ...
    <section id="mission-vision" className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="text-sm font-semibold uppercase tracking-[0.35em] text-[#71B045]">
            Guiding Purpose
          </p>
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="group relative overflow-hidden rounded-[32px] border border-gray-100 bg-white p-10 shadow-lg shadow-sky-100/40">
            <div className="flex flex-col items-center text-center">
              <div className="relative flex h-24 w-24 items-center justify-center rounded-full border-4 border-[#71B045]/30 bg-[#71B045]/10 text-[#71B045] transition-transform duration-300 group-hover:scale-105">
                <Mountain className="h-11 w-11" />
                <Flag className="absolute -bottom-2 right-1 h-6 w-6 text-[#71B045]" />
              </div>
              ...
              <div className="mt-6 flex items-center gap-3 text-base font-semibold uppercase tracking-[0.25em] text-gray-500">
                ...
                <span className="text-[#71B045]">Mission</span>
              </div>
              ...
              <p className="mt-4 text-sm text-gray-500">
                Click here for info:
                <span className="mx-1 text-[#71B045]">
              ...
              <div className="mt-6 flex h-10 w-10 items-center justify-center rounded-full bg-[#71B045]/10 text-[#71B045]">
          ...
          <div className="group relative overflow-hidden rounded-[32px] border border-gray-100 bg-white p-10 shadow-lg shadow-sky-100/40">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-6 flex items-center gap-3 text-base font-semibold uppercase tracking-[0.25em] text-gray-500">
                <span>Our</span>
                <span className="h-[1px] w-10 bg-gray-300" />
                <span className="text-[#71B045]">Vision</span>
              </div>
