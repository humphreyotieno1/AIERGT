  ...
  if (!category) {
    return (
      <main className="flex min-h-[60vh] items-center justify-center">
        <div className="rounded-3xl border border-[#71B045]/30 bg-white/90 px-8 py-12 text-center shadow-xl">
          ...
          <p className="mt-3 text-sm text-slate-600">
            ...
            <Link href="mailto:info@aiergt.africa" className="ml-1 text-[#71B045] underline">
              info@aiergt.africa
            </Link>
            .
          </p>
    ...
    <main className="relative min-h-screen overflow-hidden pb-20">
      <section className="relative isolate min-h-[200px] pb-12 pt-20">
        <div className="pointer-events-none absolute inset-0 -z-10">
          <div className="absolute inset-0 bg-gradient-to-b from-[#71B04533] via-white/70 to-white" />
        </div>
        <div className="relative mx-auto flex w-full max-w-5xl flex-col gap-10 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-6 text-center">
            <Link
              href={`/services/${category.slug}`}
              className="mx-auto inline-flex w-fit items-center gap-2 rounded-full border border-[#71B045]/30 bg-white/80 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-[#71B045] shadow-sm transition hover:border-[#71B045]"
            >
              <ArrowLeft className="h-3.5 w-3.5" /> Back to consultancy services
            </Link>
            <div className="flex flex-col items-center gap-4">
              <span className="inline-flex items-center gap-2 rounded-full border border-[#71B045]/40 bg-white/80 px-4 py-2 text-xs font-semibold uppercase tracking-[0.35em] text-[#71B045] shadow-sm">
      ...
      <section className="relative z-10 mx-auto mt-12 grid w-full max-w-6xl gap-8 px-4 sm:px-6 lg:grid-cols-[1.4fr,0.9fr] lg:px-10">
        ...
        <aside className="space-y-6">
          <div className="rounded-3xl border border-[#71B045]/35 bg-white/90 p-6 shadow-xl">
            ...
            <div className="mt-4 rounded-2xl border border-[#71B045]/20 bg-[#F7FBFF] p-4 text-sm text-slate-600">
              <p className="font-semibold text-[#71B045]">Popular services in this category:</p>
          ...
          <div className="rounded-3xl border border-[#71B045]/25 p-6 shadow-lg">
            <h3 className="text-sm font-semibold uppercase tracking-[0.35em] text-[#71B045]">
              Need additional support?
            </h3>
            <ul className="mt-4 space-y-3 text-sm text-slate-600">
              <li className="flex items-start gap-2">
                <Sparkles className="mt-1 h-4 w-4 flex-shrink-0 text-[#71B045]" />
                Request a discovery call to align expectations and co-design delivery.
              </li>
              <li className="flex items-start gap-2">
                <Sparkles className="mt-1 h-4 w-4 flex-shrink-0 text-[#71B045]" />
                Call
                <Link href="tel:+254720470545" className="ml-1 text-[#71B045] underline">
                  +254720470545
                </Link>
              </li>
              <li className="flex items-start gap-2">
