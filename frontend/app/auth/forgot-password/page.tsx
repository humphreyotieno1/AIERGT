      ...
      <div className="min-h-screen bg-gradient-to-br from-[#FEF7ED] to-white flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          ...
          <div className="mb-6">
            <Link 
              href="/auth/login" 
              className="inline-flex items-center space-x-2 text-[#71B045] hover:text-[#0F1023] transition-colors"
            >
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/contact" className="text-[#71B045] hover:underline font-medium">
                Contact Support
              </Link>
            </p>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FEF7ED] to-white flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="mx-auto w-16 h-16 bg-[#71B045] rounded-full flex items-center justify-center mb-4">
        ...
        <Card className="border-0 shadow-2xl">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-[#71B045] to-[#0F1023] hover:from-[#0F1023] hover:to-[#71B045] transition-all duration-300 shadow-lg hover:shadow-xl"
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  <Link 
                    href="/contact" 
                    className="block text-sm text-[#71B045] hover:underline"
                  >
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/auth/login" className="text-[#71B045] hover:underline font-medium">
              Sign In
            </Link>
          </p>
        </div>
