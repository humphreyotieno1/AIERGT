      ...
      <div className="min-h-screen bg-gradient-to-br from-[#FEF7ED] to-white flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          ...
          <div className="mb-6">
            <Link 
              href="/auth/login" 
              className="inline-flex items-center space-x-2 text-[#2D5016] hover:text-[#3A6B1F] transition-colors"
            >
      ...
      <div className="max-w-md w-full">
        ...
        <Card className="border-0 shadow-2xl">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-[#2D5016] to-[#3A6B1F] hover:from-[#3A6B1F] hover:to-[#2D5016] transition-all duration-300 shadow-lg hover:shadow-xl"
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  <Link 
                    href="/contact" 
                    className="block text-sm text-[#2D5016] hover:underline"
                  >
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/auth/login" className="text-[#2D5016] hover:underline font-medium">
              Sign In
            </Link>
          </p>
        </div>
