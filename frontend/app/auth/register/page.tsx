...
const userTypes = {
  AFRICAN_CONSULTANT: {
    ...
    icon: Users,
    color: "bg-[#71B045] hover:bg-[#71B045]/90"
  },
  PARTNER: {
    name: "Partners",
                      ...
                      <button
                        ...
                        className={`w-full p-4 rounded-lg border-2 transition-all duration-200 text-left ${
                          formData.userType === key
                            ? `${userType.color} text-white border-[#71B045]`
                            : "bg-white text-gray-700 border-gray-200 hover:border-[#71B045] hover:bg-gray-50"
                        }`}
                      >
                        <div className="flex items-center space-x-3">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                            formData.userType === key ? "bg-white/20" : "bg-[#71B045]/10"
                          }`}>
                            <userType.icon className={`h-5 w-5 ${
                              formData.userType === key ? "text-white" : "text-[#71B045]"
                            }`} />
                          </div>
                          <div>
            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-[#71B045] hover:bg-[#71B045]/90"
                    disabled={isLoading}
                  >
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-600">
                    ...
                    <Link href="/auth/login" className="text-[#71B045] hover:underline">
                      Sign in here
                    </Link>
                  </p>
                </div>
